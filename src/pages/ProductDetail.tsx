...
export const ProductDetail = () => {
  ...
  return (
    <Layout showBottomNav={false}>
                    ...
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        {review.is_verified_purchase && (
                          <span
                            className="text-xs px-2 py-0.5 rounded-full bg-surface-200 dark:bg-surface-600 text-surface-600 dark:text-surface-300"
                          >
      ...
      {/* ─── FIXED BOTTOM BAR ─── */}
      <div
        className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 dark:bg-surface-800/95 backdrop-blur-sm border-t border-surface-200 dark:border-surface-700 shadow-elevated pb-safe"
      >
